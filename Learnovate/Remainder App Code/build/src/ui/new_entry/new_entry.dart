  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          "Add New Medicine for Remainder",
          style: TextStyle(
            color: Colors.black,
            fontSize: 18,
          ),
        ...
        child: Provider<NewEntryBloc>.value(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              PanelTitle(
                title: "Select interval of Remainder: ",
                isRequired: true,
              ),
              //ScheduleCheckBoxes(),
              IntervalSelection(),
  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    ...
    for (int i = 0; i < (24 / medicine.interval).floor(); i++) {
      ...
      await flutterLocalNotificationsPlugin.showDailyAtTime(
          ...
          'We Care 4 U Remainder: ${medicine.medicineName}',
      ...
      child: Container(
        child: Row(
          ...
          children: <Widget>[
            ...
            DropdownButton<int>(
              iconEnabledColor: Color(0xFF00BCD4),
              hint: _selected == 0
                  ? Text(
                      "Select an Interval",
                      style: TextStyle(
        ...
        children: <Widget>[
            ...
            child: Center(
              child: Padding(
                ...
                child: Icon(
                  ...
                  size: 75,
                  color: isSelected ? Colors.white : Color(0xFF00BCD4),
                ),
              ),
            ),
          ),
          Padding(
            ...
            child: Container(
              ...
              height: 30,
              decoration: BoxDecoration(
                color: isSelected ? Color(0xFF00BCD4) : Colors.transparent,
